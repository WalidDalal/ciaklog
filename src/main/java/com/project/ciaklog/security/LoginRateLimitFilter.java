...
public class LoginRateLimitFilter extends OncePerRequestFilter {
    ...
    // Limite per IP, distinto da quello per email in AuthServiceImpl: qui
    // largo (scanning/credential-stuffing su molti account dallo stesso IP),
    // quello per email resta stretto (blocca solo l'account preso di mira)
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        // Registra solo i fallimenti (401), non i login riusciti
