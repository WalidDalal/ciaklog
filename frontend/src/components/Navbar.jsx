...
function Navbar() {
    ...
    const handleSearch = (e) => {
        // Fix (ricerca — validazione): il backend richiede almeno 2 caratteri
        // (@Size(min=2) su TmdbController.search) — un invio con 1 solo carattere
        // arrivava comunque al backend e falliva con un errore di validazione
        // loggato come "non gestito". Bloccato qui prima ancora di partire.
