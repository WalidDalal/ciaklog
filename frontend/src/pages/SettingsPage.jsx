  ...
  return (
    <div style={{ backgroundColor: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: '40px 24px' }}>
        <h1 style={{ fontSize: '28px', fontWeight: '800', color: 'var(--text)', marginBottom: '40px' }}>
          ⚙️ Impostazioni
        </h1>

        {/* Modifica username */}
        <div style={{ backgroundColor: 'var(--bg-card)', border: '1px solid #222', borderRadius: '12px', padding: '28px', marginBottom: '24px' }}>
          ...
          <form onSubmit={handleUsernameSubmit}>
            ...
            <button type="submit" disabled={loadingUsername} style={{ padding: '12px 28px', backgroundColor: loadingUsername ? '#666' : 'var(--accent)', border: 'none', borderRadius: '8px', color: 'var(--text)', fontSize: '15px', fontWeight: '600' }}>
        ...
        {/* Cambia password */}
        <div style={{ backgroundColor: 'var(--bg-card)', border: '1px solid #222', borderRadius: '12px', padding: '28px' }}>
          <h2 style={{ color: 'var(--text)', fontSize: '18px', fontWeight: '700', marginBottom: '20px' }}>
            🔒 Cambia password
          </h2>
          <form onSubmit={handlePasswordSubmit}>
            ...
            <button type="submit" disabled={loadingPassword} style={{ padding: '12px 28px', backgroundColor: loadingPassword ? '#666' : 'var(--accent)', border: 'none', borderRadius: '8px', color: 'var(--text)', fontSize: '15px', fontWeight: '600' }}>
