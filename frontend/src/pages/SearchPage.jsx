...
function SearchPage() {
  ...
  useEffect(() => {
    // Fix (ricerca — validazione): stessa regola del backend (min 2 caratteri) —
    // copre il caso di chi arriva qui con un URL modificato a mano (?q=a)
    // invece che dalla barra di ricerca, dove il controllo è già a monte
